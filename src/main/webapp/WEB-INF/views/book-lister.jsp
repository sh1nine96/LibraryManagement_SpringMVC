...
<body>
	...
	<div class="container">
		...
		<form action="/LibraryManagement/books/listing/search" class="form-inline">

			<!-- Add a button -->
			<a href="/LibraryManagement/books/begin-add"
		...
		<table class="table table-bordered table-striped">
			...
			<tbody>
				<c:forEach items="${BooksCollection}" var="tempBook">
					<tr>
						...
						<td>
							...
							href="/LibraryManagement/books/listing/begin-update?bookId=${tempBook.id}"
							class="btn btn-info btn-sm"> Update </a> 
							
							<!-- Add "delete" button/link -->
							<a href="/LibraryManagement/books/listing/delete?bookId=${tempBook.id}"
